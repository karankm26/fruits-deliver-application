  ...
  render() {
    ...
    this.tempDiv.innerHTML = `
      ...
      ${needsNavigation(this.passedParams) ? `
        <div part="button-prev" className="swiper-button-prev"></div>
        <div part="button-next" className="swiper-button-next"></div>
      ` : ''}
      ${needsPagination(this.passedParams) ? `
        <div part="pagination" className="swiper-pagination"></div>
      ` : '' }
      ${needsScrollbar(this.passedParams) ? `
        <div part="scrollbar" className="swiper-scrollbar"></div>
      ` : '' }
    `;
