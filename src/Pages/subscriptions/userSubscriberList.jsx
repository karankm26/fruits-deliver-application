...
import { allUsersSubscriptions } from "../../features/apiSlice";
...
export default function UserSubscriptionList() {
  ...
  const { allUsersSubscriptionsData } = useSelector((state) => state.api);
  const count = allUsersSubscriptionsData.total ?? 0;

  useEffect(() => {
    dispatch(allUsersSubscriptions({ search, limit, currentPage }));
      ...
      <div className="row">
        <div className="col-12">
          <div className="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 className="mb-sm-0">Manage Subscriptions</h4>
        ...
        <div className="col-lg-12">
          <div className="card">
            <div className="card-header">
              <h5 className="card-title mb-0">Users Subscriptions List</h5>
            </div>
            <div className="card-body table-responsive">
              ...
              >
                ...
                <tbody>
                  {allUsersSubscriptionsData?.SubscriptionUser?.length
                    ? allUsersSubscriptionsData?.SubscriptionUser.map(
                        (item, index) => (
                          <tr key={index}>
                            <td>{index + 1}</td>
                            <td>
