...
import { getOperators } from "../../features/apiSlice";

export default function OpertorList() {
  ...
  const { getOperatorsData, getOperatorsDataLoading } = useSelector(
    (state) => state.api
  );

  const count = getOperatorsData?.count;

  useEffect(() => {
    dispatch(getOperators({ search, limit, currentPage }));
          ...
          <div className="card">
            ...
            <div className="card-body table-responsive">
              ...
              >
                ...
                <tbody>
                  {getOperatorsData?.operator?.length
                    ? getOperatorsData?.operator.map((item, index) => (
                        <tr key={index}>
                          <td>{index + 1}</td>
                          <td>
