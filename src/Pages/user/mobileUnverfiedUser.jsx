...
export default function MobileUnverfiedUsers() {
  ...
  useEffect(() => {
    dispatch(
      fetchUsers({ search, limit, type: "mobile-unverified", currentPage })
    );
        ...
        <div className="col-lg-12">
          <div className="card">
            <div className="card-header">
              <h5 className="card-title mb-0">Mobile Unverfied Users</h5>
            </div>
