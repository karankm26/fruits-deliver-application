    ...
    Array.from(Invoices).forEach(function (e) {
      ...
      var a =
        `<tr>
                ...
                <td className="id"><a href="javascript:void(0);" onclick="ViewInvoice(this);" data-id="` +
        e.invoice_no +
        '" className="fw-medium link-primary">#VL' +
        e.invoice_no +
        `</a></td>
        ...
        e.invoice_amount +
        `</td>
                <td className="status"><span className="badge bg-` +
        t +
        "-subtle text-" +
        t +
        ' text-uppercase">' +
                ...
                <td>
                    <div className="dropdown">
                        ...
                        <ul className="dropdown-menu dropdown-menu-end">
                            <li><button className="dropdown-item" href="javascript:void(0);" onclick="ViewInvoice(this);" data-id="` +
        e.invoice_no +
        `" ><i className="ri-eye-fill align-bottom me-2 text-muted"></i>
                                    View</button></li>
                            <li><button className="dropdown-item" href="javascript:void(0);" onclick="EditInvoice(this);" data-id="` +
        e.invoice_no +
          ...
          for (i = 0; i < ids_array.length; i++)
            invoiceList.remove(
              ...
              '<a href="javascript:void(0);" onclick="ViewInvoice(this);" data-id="' +
                ids_array[i].slice(3) +
                `" className="fw-medium link-primary">${ids_array[i]}</a>`
            );
