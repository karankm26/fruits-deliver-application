      ...
      custom: [
        ...
        function (e) {
          var t = e.seriesIndex,
            ...
            e = e.w;
          return (
            '<div className="apexcharts-tooltip-candlestick"><div>Open: <span className="value">' +
            e.globals.seriesCandleO[t][a] +
            '</span></div><div>High: <span className="value">' +
            e.globals.seriesCandleH[t][a] +
            '</span></div><div>Low: <span className="value">' +
            e.globals.seriesCandleL[t][a] +
            '</span></div><div>Close: <span className="value">' +
