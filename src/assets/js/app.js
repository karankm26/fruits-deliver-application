  ...
  function i() {
    ...
    !t ||
      ...
      ((n = document.createElement("ul")).innerHTML =
        '<a href="#" className="logo"><img src="assets/images/logo-sm.png" alt="" height="22"></a>'),
      Array.from(
    ...
    Array.from(n).forEach(function (e, t) {
      t + 1 === a && (s = e),
        ...
        t + 1 === n.length &&
          ...
          s.insertAdjacentHTML(
            "afterend",
            '<li className="nav-item">\t\t\t\t\t\t<a className="nav-link" href="#sidebarMore" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarMore">\t\t\t\t\t\t\t<i className="ri-briefcase-2-line"></i> <span data-key="t-more">More</span>\t\t\t\t\t\t</a>\t\t\t\t\t\t<div className="collapse menu-dropdown" id="sidebarMore"><ul className="nav nav-sm flex-column">' +
              o +
              "</ul></div>\t\t\t\t\t</li>"
          );
    });
      ...
      0 < e.querySelectorAll(".notification-item").length
        ...
        : (e.querySelector(".view-all") &&
          ...
          e.querySelector(".empty-notification-elem") ||
            (e.innerHTML +=
              '<div className="empty-notification-elem">\t\t\t\t\t\t\t<div className="w-25 w-sm-50 pt-3 mx-auto">\t\t\t\t\t\t\t\t<img src="assets/images/svg/bell.svg" className="img-fluid" alt="user-pic">\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t<div className="text-center pb-5 mt-2">\t\t\t\t\t\t\t\t<h6 className="fs-18 fw-semibold lh-base">Hey! You have no any notifications </h6>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t</div>'));
    });
  }
  function W() {
    var e;
