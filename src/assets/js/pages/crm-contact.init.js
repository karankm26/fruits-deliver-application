...
(xhttp.onload = function () {
  ...
  Array.from(e).forEach(function (e) {
    ...
    Array.from(t).forEach((e, t) => {
      ...
      contactList.add({
        id: `<a href="javascript:void(0);" className="fw-medium link-primary">#VZ${e.id}</a>`,
        name:
          '<div className="d-flex align-items-center">            <div className="flex-shrink-0"><img src="' +
          e.name[0] +
          '" alt="" className="avatar-xs rounded-circle"></div>            <div className="flex-grow-1 ms-2 name">' +
          e.name[1] +
          "</div>            </div>",
                            ...
                            <div className="position-relative d-inline-block">
                                <img src="${
                                  new DOMParser()
                                    ...
                                    className="avatar-lg rounded-circle img-thumbnail object-fit-cover">
                                <span className="contact-active position-absolute rounded-circle bg-success"><span
                                ...
                                <table className="table table-borderless mb-0">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>${
                                              e._values.date
                                            } <small className="text-muted"></small></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
        ...
        ? (e.preventDefault(),
          ...
          editlist
            ? "" !== customerNameField.value &&
              ...
              Array.from(t).forEach(function (e) {
                ...
                Array.from(a).forEach((e, t) => {
                  ...
                  t == itemId &&
                    e.values({
                      id: `<a href="javascript:void(0);" className="fw-medium link-primary">#VZ${idField.value}</a>`,
                      name:
                        '<div className="d-flex align-items-center">                            <div className="flex-shrink-0"><img src="' +
                        customerImg.src +
                        '" alt="" className="avatar-xs rounded-circle object-fit-cover"></div>                            <div className="flex-grow-1 ms-2 name">' +
                        customerNameField.value +
                        "</div>                            </div>",
            ...
            : ((t = tagInputField.getValue(!0)),
              ...
              contactList.add({
                id: `<a href="javascript:void(0);" className="fw-medium link-primary">#VZ${count}</a>`,
                name:
                  '<div className="d-flex align-items-center">                    <div className="flex-shrink-0"><img src="' +
                  customerImg.src +
                  '" alt="" className="avatar-xs rounded-circle object-fit-cover"></div>                    <div className="flex-grow-1 ms-2 name">' +
