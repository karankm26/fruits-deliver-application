...
(xhttp.onload = function () {
  ...
  Array.from(e).forEach(function (e) {
    orderList.add({
      id:
        '<a href="apps-ecommerce-order-details.html" className="fw-medium link-primary">#VZ' +
        e.id +
        "</a>",
    ...
    orderList.remove(
      "id",
      '<a href="apps-ecommerce-order-details.html" className="fw-medium link-primary">#VZ2101</a>'
    );
}),
