...
export default function EmailVerfiedUsers() {
  ...
  useEffect(() => {
    dispatch(
      fetchUsers({ search, limit, type: "verified_email", currentPage })
    );
          ...
          <div className="page-title-box d-sm-flex align-items-center justify-content-between">
            ...
            <div className="page-title-right">
              <ol className="breadcrumb m-0">
                ...
                <li className="breadcrumb-item active">Email Verified Users</li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div className="col-lg-12">
          <div className="card">
            <div className="card-header">
              <h5 className="card-title mb-0">Email Verified Users</h5>
            </div>
