  ...
  document
    ...
    Array.from(e).forEach(function (e, t) {
      ...
      (document.querySelector("#mail-list").innerHTML +=
        '<li className="' +
        a +
        '">        <div className="col-mail col-mail-1">            <div className="form-check checkbox-wrapper-mail fs-14">                <input className="form-check-input" type="checkbox" value="' +
        e.id +
        '" id="checkbox-' +
        e.id +
        ...
        e.userImg +
        ' className="mail-userimg" />            <button type="button" className="btn avatar-xs p-0 favourite-btn fs-15 ' +
        l +
        '">            <i className="ri-star-fill"></i>            </button>            <a href="javascript: void(0);" className="title"><span className="title-name">' +
        e.name +
        "</span> " +
        c +
        '</a>        </div>        <div className="col-mail col-mail-2">            <a href="javascript: void(0);" className="subject"><span className="subject-title">' +
        e.title +
        '</span> – <span className="teaser">' +
        e.description +
        '</span>            </a>            <div className="date">' +
        e.date +
        "</div>        </div>    </li>"),
        favouriteBtn(),
        emailDetailShow(),
...
function emailDetailChange() {
  Array.from(document.querySelectorAll(".message-list li")).forEach(function (
    ...
    c.addEventListener("click", function () {
      var e = c.querySelector(".checkbox-wrapper-mail .form-check-input").value,
        e =
          (document
