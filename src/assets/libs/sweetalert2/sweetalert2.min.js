...
!(function (e, t) {
  ...
  const n = "swal2-",
    ...
    oe =
      `\n <div aria-labelledby="${i.title}" aria-describedby="${i["html-container"]}" className="${i.popup}" tabindex="-1">\n   <button type="button" className="${i.close}"></button>\n   <ul className="${i["progress-steps"]}"></ul>\n   <div className="${i.icon}"></div>\n   <img className="${i.image}" />\n   <h2 className="${i.title}" id="${i.title}"></h2>\n   <div className="${i["html-container"]}" id="${i["html-container"]}"></div>\n   <input className="${i.input}" />\n   <input type="file" className="${i.file}" />\n   <div className="${i.range}">\n     <input type="range" />\n     <output></output>\n   </div>\n   <select className="${i.select}"></select>\n   <div className="${i.radio}"></div>\n   <label for="${i.checkbox}" className="${i.checkbox}">\n     <input type="checkbox" />\n     <span className="${i.label}"></span>\n   </label>\n   <textarea className="${i.textarea}"></textarea>\n   <div className="${i["validation-message"]}" id="${i["validation-message"]}"></div>\n   <div className="${i.actions}">\n     <div className="${i.loader}"></div>\n     <button type="button" className="${i.confirm}"></button>\n     <button type="button" className="${i.deny}"></button>\n     <button type="button" className="${i.cancel}"></button>\n   </div>\n   <div className="${i.footer}"></div>\n   <div className="${i["timer-progress-bar-container"]}">\n     <div className="${i["timer-progress-bar"]}"></div>\n   </div>\n </div>\n`.replace(
        /(^|\n)\s*/g,
        ""
      ),
    ne = () => {
  ...
  const Ce = (e, t) => {
    ...
    Ee = (e) => `<div className="${i["icon-content"]}">${e}</div>`,
    $e = (e, t) => {
      const o = t.showClass || {};
