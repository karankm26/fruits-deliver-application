                ...
                var e = t.options,
                  ...
                  l = f(
                    '\n      <div :ref="root" className="pickr">\n\n        ' +
                      ...
                      s(r.palette) +
                      '>\n            <div :obj="preview" className="pcr-color-preview" ' +
                      s(r.preview) +
                      '>\n              <button type="button" :ref="lastColor" className="pcr-last-color" aria-label="' +
                      u("btn:last-color") +
                      '"></button>\n              <div :ref="currentColor" className="pcr-current-color"></div>\n            </div>\n\n            <div :obj="palette" className="pcr-color-palette">\n              <div :ref="picker" className="pcr-picker"></div>\n              <div :ref="palette" className="pcr-palette" tabindex="0" aria-label="' +
                      u("aria:palette") +
                      '" role="listbox"></div>\n            </div>\n\n            <div :obj="hue" className="pcr-color-chooser" ' +
                      s(r.hue) +
                      '>\n              <div :ref="picker" className="pcr-picker"></div>\n              <div :ref="slider" className="pcr-hue pcr-slider" tabindex="0" aria-label="' +
                      u("aria:hue") +
                      '" role="slider"></div>\n            </div>\n\n            <div :obj="opacity" className="pcr-color-opacity" ' +
                      s(r.opacity) +
                      '>\n              <div :ref="picker" className="pcr-picker"></div>\n              <div :ref="slider" className="pcr-opacity pcr-slider" tabindex="0" aria-label="' +
                      u("aria:opacity") +
                      '" role="slider"></div>\n            </div>\n          </div>\n\n          <div className="pcr-swatches ' +
                      (r.palette ? "" : "pcr-last") +
                      '" :ref="swatches"></div>\n\n          <div :obj="interaction" className="pcr-interaction" ' +
                      s(Object.keys(r.interaction).length) +
                      '>\n            <input :ref="result" className="pcr-result" type="text" spellcheck="false" ' +
                      ...
                      '>\n            <input :arr="options" className="pcr-type" data-type="CMYK" value="CMYK" type="button" ' +
                      s(r.interaction.cmyk) +
                      '>\n\n            <input :ref="save" className="pcr-save" value="' +
                      u("btn:save") +
                      '" type="button" ' +
                      s(r.interaction.save) +
                      ' aria-label="' +
                      u("aria:btn:save") +
                      '">\n            <input :ref="cancel" className="pcr-cancel" value="' +
                      u("btn:cancel") +
                      '" type="button" ' +
                      s(r.interaction.cancel) +
                      ' aria-label="' +
                      u("aria:btn:cancel") +
                      '">\n            <input :ref="clear" className="pcr-clear" value="' +
                      u("btn:clear") +
                      '" type="button" ' +
