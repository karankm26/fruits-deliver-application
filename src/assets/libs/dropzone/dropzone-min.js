!(function () {
  ...
  var p = {
      ...
      previewTemplate: e(
        '<div className="dz-file-preview dz-preview"> <div className="dz-image"><img data-dz-thumbnail=""></div> <div className="dz-details"> <div className="dz-size"><span data-dz-size=""></span></div> <div className="dz-filename"><span data-dz-name=""></span></div> </div> <div className="dz-progress"> <span className="dz-upload" data-dz-uploadprogress=""></span> </div> <div className="dz-error-message"><span data-dz-errormessage=""></span></div> <div className="dz-success-mark"> <svg width="54" height="54" fill="#fff"><path d="m10.207 29.793 4.086-4.086a1 1 0 0 1 1.414 0l5.586 5.586a1 1 0 0 0 1.414 0l15.586-15.586a1 1 0 0 1 1.414 0l4.086 4.086a1 1 0 0 1 0 1.414L22.707 42.293a1 1 0 0 1-1.414 0L10.207 31.207a1 1 0 0 1 0-1.414Z"/></svg> </div> <div className="dz-error-mark"> <svg width="54" height="54" fill="#fff"><path d="m26.293 20.293-7.086-7.086a1 1 0 0 0-1.414 0l-4.586 4.586a1 1 0 0 0 0 1.414l7.086 7.086a1 1 0 0 1 0 1.414l-7.086 7.086a1 1 0 0 0 0 1.414l4.586 4.586a1 1 0 0 0 1.414 0l7.086-7.086a1 1 0 0 1 1.414 0l7.086 7.086a1 1 0 0 0 1.414 0l4.586-4.586a1 1 0 0 0 0-1.414l-7.086-7.086a1 1 0 0 1 0-1.414l7.086-7.086a1 1 0 0 0 0-1.414l-4.586-4.586a1 1 0 0 0-1.414 0l-7.086 7.086a1 1 0 0 1-1.414 0Z"/></svg> </div> </div>'
      ),
      drop: function (e) {
          ...
          [
            ...
            },
            {
              ...
              value: function () {
                ...
                var i = '<div className="dz-fallback">';
