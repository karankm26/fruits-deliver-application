  ...
  (this.functions = {
    ...
    (this.emojiPicker = () => {
      ...
      const closeBtn = this.variable.closeButton
        ? `<li><a className="fg-emoji-picker-close-button" href="#">${this.variable.categoryIcons.close}</a></li>`
        : "";
        ...
        fetchData = new Promise((resolve, reject) => {
          ...
          for (const key in object) {
            if (object.hasOwnProperty(key)) {
              ...
              innerLists += `
                            <ul className="fg-emoji-picker-category ${
                              index === 1 ? "active" : ""
              ...
              categories.forEach((item) => {
                innerLists += `<li data-name="${item.description.toLowerCase()}"><a className="fg-emoji-picker-item" title="${
                  item.description
