...
function newKanbanbaord() {
  var e = document.getElementById("boardName").value,
    ...
    t = "review_task_" + a;
  (kanbanlisthtml =
    '<div className="tasks-list" id=' +
    ("remove_item_" + a) +
    '><div className="d-flex mb-3"><div className="flex-grow-1"><h6 className="fs-14 text-uppercase fw-semibold mb-0">' +
    e +
    '<small className="badge bg-success align-bottom ms-1 totaltask-badge">0</small></h6></div><div className="flex-shrink-0"><div className="dropdown card-header-dropdown"><a className="text-reset dropdown-btn" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span className="fw-medium text-muted fs-12">Priority<i className="mdi mdi-chevron-down ms-1"></i></span></a><div className="dropdown-menu dropdown-menu-end"><a className="dropdown-item" href="#">Priority</a><a className="dropdown-item" href="#">Date Added</a></div></div></div></div><div data-simplebar className="tasks-wrapper px-3 mx-n3"><div className="tasks" id="' +
    t +
    '" ></div></div><div className="my-3"><button className="btn btn-soft-info w-100" data-bs-toggle="modal" data-bs-target="#creatertaskModal">Add More</button></div></div>'),
    document
...
function newMemberAdd() {
  ...
  (newMembar =
    '<a href="javascript: void(0);" className="avatar-group-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="' +
    e +
    '">' +
    a +
    "</a>"),
    ...
    reader.readAsDataURL(profileField.files[0]),
      (reader.onload = function () {
        ...
        localStorage.setItem(
          ...
          '<img src="' +
            e +
            '" alt="profile" className="rounded-circle avatar-xs">'
        );
      });
  }));
