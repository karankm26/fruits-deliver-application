    ...
    e[i] &&
      ((n = e[i].userImg
        ...
        : '<div className="avatar-title border bg-light text-primary rounded text-uppercase fs-24">' +
          ...
          "</div>"),
      (document.querySelector("#candidate-list").innerHTML +=
        '<div className="col-xxl-3 col-md-6">    <div className="card">        <div className="card-body">            <div className="d-flex align-items-center">                <div className="flex-shrink-0">                    <div className="avatar-lg rounded">' +
        n +
        '</div>                </div>                <div className="flex-grow-1 ms-3">                    <a href="pages-profile.html">                        <h5 className="fs-16 mb-1">' +
        e[i].candidateName +
        '</h5>                    </a>                    <p className="text-muted mb-2">' +
        e[i].designation +
        '</p>                    <div className="d-flex flex-wrap gap-2 align-items-center">                    <div className="badge text-bg-success"><i className="mdi mdi-star me-1"></i>' +
        e[i].rating[0] +
        '</div>                        <div className="text-muted">' +
        e[i].rating[1] +
        '</div>                    </div>                    <div className="d-flex gap-4 mt-2 text-muted">                        <div>                            <i className="ri-map-pin-2-line text-primary me-1 align-bottom"></i> ' +
        e[i].location +
