        ...
        (a = (function () {
          ...
          return (
            ...
            (t.prototype.cardTemplate =
              '<div className="jp-card-container"><div className="jp-card"><div className="jp-card-front"><div className="jp-card-logo jp-card-elo"><div className="e">e</div><div className="l">l</div><div className="o">o</div></div><div className="jp-card-logo jp-card-visa">Visa</div><div className="jp-card-logo jp-card-visaelectron">Visa<div className="elec">Electron</div></div><div className="jp-card-logo jp-card-mastercard">Mastercard</div><div className="jp-card-logo jp-card-maestro">Maestro</div><div className="jp-card-logo jp-card-amex"></div><div className="jp-card-logo jp-card-discover">discover</div><div className="jp-card-logo jp-card-unionpay">UnionPay</div><div className="jp-card-logo jp-card-dinersclub"></div><div className="jp-card-logo jp-card-hipercard">Hipercard</div><div className="jp-card-logo jp-card-troy">troy</div><div className="jp-card-logo jp-card-dankort"><div className="dk"><div className="d"></div><div className="k"></div></div></div><div className="jp-card-logo jp-card-jcb"><div className="j">J</div><div className="c">C</div><div className="b">B</div></div><div className="jp-card-lower"><div className="jp-card-shiny"></div><div className="jp-card-cvc jp-card-display">{{cvc}}</div><div className="jp-card-number jp-card-display">{{number}}</div><div className="jp-card-name jp-card-display">{{name}}</div><div className="jp-card-expiry jp-card-display" data-before="{{monthYear}}" data-after="{{validDate}}">{{expiry}}</div></div></div><div className="jp-card-back"><div className="jp-card-bar"></div><div className="jp-card-cvc jp-card-display">{{cvc}}</div><div className="jp-card-shiny"></div></div></div></div>'),
