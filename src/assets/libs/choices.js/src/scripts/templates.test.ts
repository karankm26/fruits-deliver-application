...
describe('templates', () => {
      ...
      describe('search enabled', () => {
        it('returns expected html', () => {
          ...
          const expectedOutput = strToEl(`
            <div
              className="${options.classNames.containerOuter}"
  ...
  describe('containerInner', () => {
    it('returns expected html', () => {
      ...
      const expectedOutput = strToEl(
        `<div className="${innerOptions.classNames.containerInner}"></div>`,
      );
  ...
  describe('itemList', () => {
    ...
    describe('select one element', () => {
      it('returns expected html', () => {
        const expectedOutput = strToEl(
          `<div className="${itemOptions.classNames.list} ${itemOptions.classNames.listSingle}"></div>`,
        );
    ...
    describe('non select one element', () => {
      it('returns expected html', () => {
        const expectedOutput = strToEl(
          `<div className="${itemOptions.classNames.list} ${itemOptions.classNames.listItems}"></div>`,
        );
  ...
  describe('placeholder', () => {
    it('returns expected html', () => {
      ...
      const value = 'test';
      const expectedOutput = strToEl(`
        <div className="${placeholderOptions.classNames.placeholder}">${value}</div>`);
  ...
  describe('choiceList', () => {
    ...
    describe('select one element', () => {
      it('returns expected html', () => {
        const expectedOutput = strToEl(`
          <div
            className="${choiceListOptions.classNames.list}"
            role="listbox"
            >
          </div>
        `);
  ...
  describe('choiceGroup', () => {
    ...
    describe('enabled state', () => {
      it('returns expected html', () => {
        const expectedOutput = strToEl(`
          <div
          className="${groupOptions.classNames.group}"
            data-group
            data-id="${data.id}"
            data-value="${data.value}"
            role="group"
            >
            <div className="${groupOptions.classNames.groupHeading}">${data.value}</div>
          </div>
        `);
    ...
    describe('disabled state', () => {
      ...
      it('returns expected html', () => {
        const expectedOutput = strToEl(`
          <div
            className="${groupOptions.classNames.group} ${groupOptions.classNames.itemDisabled}"
            data-group
            data-id="${data.id}"
            data-value="${data.value}"
            role="group"
  ...
  describe('choice', () => {
    ...
    describe('enabled state', () => {
      it('returns expected html', () => {
        const expectedOutput = strToEl(`
          <div
            className="${choiceOptions.classNames.item} ${choiceOptions.classNames.itemChoice} ${choiceOptions.classNames.itemSelectable}"
    ...
    describe('disabled state', () => {
      ...
      it('returns expected html', () => {
        const expectedOutput = strToEl(`
          <div
            className="${choiceOptions.classNames.item} ${choiceOptions.classNames.itemChoice} ${choiceOptions.classNames.itemDisabled}"
            data-select-text="${itemSelectText}"
            data-choice
            data-id="${data.id}"
            data-value="${data.value}"
    ...
    describe('selected state', () => {
      ...
      it('returns expected html', () => {
        const expectedOutput = strToEl(`
          <div
            className="${choiceOptions.classNames.item} ${choiceOptions.classNames.itemChoice} ${choiceOptions.classNames.selectedState} ${choiceOptions.classNames.itemSelectable}"
            data-select-text="${itemSelectText}"
            data-choice
            data-id="${data.id}"
            data-value="${data.value}"
    ...
    describe('placeholder', () => {
      ...
      it('returns expected html', () => {
        const expectedOutput = strToEl(`
          <div
            className="${choiceOptions.classNames.item} ${choiceOptions.classNames.itemChoice} ${choiceOptions.classNames.placeholder} ${choiceOptions.classNames.itemSelectable}"
            data-select-text="${itemSelectText}"
            data-choice
            data-id="${data.id}"
            data-value="${data.value}"
      ...
      */
      const expectedOutput = strToEl(`
        <input
          type="search"
          name="search_terms"
          className="${inputOptions.classNames.input} ${inputOptions.classNames.inputCloned}"
          autocomplete="off"
          role="textbox"
          aria-autocomplete="list"
  ...
  describe('dropdown', () => {
    ...
    it('returns expected html', () => {
      const expectedOutput = strToEl(
        `<div className="${dropdownOptions.classNames.list} ${dropdownOptions.classNames.listDropdown}" aria-expanded="false"></div>`,
      );
  ...
  describe('notice', () => {
    ...
    it('returns expected html', () => {
      const expectedOutput = strToEl(`
        <div className="${noticeOptions.classNames.item} ${noticeOptions.classNames.itemChoice}">
          ${label}
        </div>
      `);
    ...
    describe('passing a notice type', () => {
      describe('no results', () => {
        it('adds no results classname', () => {
          const expectedOutput = strToEl(`
            <div className="${noticeOptions.classNames.item} ${noticeOptions.classNames.itemChoice} ${noticeOptions.classNames.noResults}">
              ${label}
            </div>
          `);
      ...
      describe('no choices', () => {
        it('adds no choices classname', () => {
          const expectedOutput = strToEl(`
            <div className="${noticeOptions.classNames.item} ${noticeOptions.classNames.itemChoice} ${noticeOptions.classNames.noChoices}">
              ${label}
            </div>
          `);
          const actualOutput = templates.notice(
