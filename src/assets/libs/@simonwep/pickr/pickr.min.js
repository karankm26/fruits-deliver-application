          ...
          const {
            ...
            p = a(
              `\n      <div :ref="root" className="pickr">\n\n        ${
                o
                  ? ""
                  : '<button type="button" :ref="button" className="pcr-button"></button>'
              }\n\n        <div :ref="app" className="pcr-app ${
                i || ""
              }" data-theme="${s}" ${
                n ? 'style="position: unset"' : ""
              } aria-label="${c(
                "ui:dialog"
              )}" role="window">\n          <div className="pcr-selection" ${l(
                e.palette
              )}>\n            <div :obj="preview" className="pcr-color-preview" ${l(
                e.preview
              )}>\n              <button type="button" :ref="lastColor" className="pcr-last-color" aria-label="${c(
                "btn:last-color"
              )}"></button>\n              <div :ref="currentColor" className="pcr-current-color"></div>\n            </div>\n\n            <div :obj="palette" className="pcr-color-palette">\n              <div :ref="picker" className="pcr-picker"></div>\n              <div :ref="palette" className="pcr-palette" tabindex="0" aria-label="${c(
                "aria:palette"
              )}" role="listbox"></div>\n            </div>\n\n            <div :obj="hue" className="pcr-color-chooser" ${l(
                e.hue
              )}>\n              <div :ref="picker" className="pcr-picker"></div>\n              <div :ref="slider" className="pcr-hue pcr-slider" tabindex="0" aria-label="${c(
                "aria:hue"
              )}" role="slider"></div>\n            </div>\n\n            <div :obj="opacity" className="pcr-color-opacity" ${l(
                e.opacity
              )}>\n              <div :ref="picker" className="pcr-picker"></div>\n              <div :ref="slider" className="pcr-opacity pcr-slider" tabindex="0" aria-label="${c(
                "aria:opacity"
              )}" role="slider"></div>\n            </div>\n          </div>\n\n          <div className="pcr-swatches ${
                e.palette ? "" : "pcr-last"
              }" :ref="swatches"></div>\n\n          <div :obj="interaction" className="pcr-interaction" ${l(
                Object.keys(e.interaction).length
              )}>\n            <input :ref="result" className="pcr-result" type="text" spellcheck="false" ${l(
                e.interaction.input
              )} aria-label="${c(
                "aria:input"
              )}">\n\n            <input :arr="options" className="pcr-type" data-type="HEXA" value="${
                r ? "HEX" : "HEXA"
              }" type="button" ${l(
                e.interaction.hex
              )}>\n            <input :arr="options" className="pcr-type" data-type="RGBA" value="${
                r ? "RGB" : "RGBA"
              }" type="button" ${l(
                e.interaction.rgba
              )}>\n            <input :arr="options" className="pcr-type" data-type="HSLA" value="${
                r ? "HSL" : "HSLA"
              }" type="button" ${l(
                e.interaction.hsla
              )}>\n            <input :arr="options" className="pcr-type" data-type="HSVA" value="${
                r ? "HSV" : "HSVA"
              }" type="button" ${l(
                e.interaction.hsva
              )}>\n            <input :arr="options" className="pcr-type" data-type="CMYK" value="CMYK" type="button" ${l(
                e.interaction.cmyk
              )}>\n\n            <input :ref="save" className="pcr-save" value="${c(
                "btn:save"
              )}" type="button" ${l(e.interaction.save)} aria-label="${c(
                "aria:btn:save"
              )}">\n            <input :ref="cancel" className="pcr-cancel" value="${c(
                "btn:cancel"
              )}" type="button" ${l(e.interaction.cancel)} aria-label="${c(
                "aria:btn:cancel"
              )}">\n            <input :ref="clear" className="pcr-clear" value="${c(
                "btn:clear"
