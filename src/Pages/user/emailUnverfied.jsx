...
export default function EmailUnverfiedUsers() {
  ...
  useEffect(() => {
    dispatch(
      fetchUsers({ search, limit, type: "unverified_email", currentPage })
    );
        ...
        <div className="col-lg-12">
          <div className="card">
            <div className="card-header">
              <h5 className="card-title mb-0">Email Unverified Users</h5>
            </div>
