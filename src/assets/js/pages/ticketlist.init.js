  ...
  Array.from(e).forEach(function (e) {
    ticketsList.add({
      id:
        ...
        e.id +
        '" className="fw-medium link-primary ticket-id">#VLZ' +
        e.id +
        "</a>",
    ...
    ticketsList.remove(
      "id",
      '<a href="javascript:void(0);" onclick="ViewTickets(this)" data-id="001" className="fw-medium link-primary">#VLZ001</a>'
    );
}),
    ...
    ? Swal.fire({
        ...
        if (e.value) {
          for (i = 0; i < ids_array.length; i++)
            ticketsList.remove(
              "id",
              `<a href="javascript:void(0);" onclick="ViewTickets(this)" data-id="${ids_array[i]}" className="fw-medium link-primary ticket-id">#VLZ${ids_array[i]}</a>`
            );
