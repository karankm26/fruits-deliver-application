...
var C = {
  ...
  X = function (t) {
    ...
    var h = l.yLbFormatter(t.w.globals.series[o][n]),
      c = '<span className="value start-value">\n  '
        .concat(
          s,
        ...
        .concat(r, "\n  </span>");
    return (
      '<div className="apexcharts-tooltip-rangebar"><div> <span className="series-name" style="color: ' +
      e +
      '">' +
      (i || "") +
      '</span></div><div> <span className="category">' +
      a +
      ": </span> " +
        ...
        },
        {
          ...
          value: function (t, e, i, a, s) {
            ...
            return t.config.series[e].type && t.config.series[e].type !== s
              ? '<div className="apexcharts-custom-tooltip">\n          '
                  .concat(
              ...
              : '<div className="apexcharts-tooltip-box apexcharts-tooltip-'.concat(
                  ...
                  "<div>".concat(a[0], ': <span className="value">') +
                  r +
                  "</span></div>" +
                  "<div>".concat(a[1], ': <span className="value">') +
                  o +
                  "</span></div>" +
                  (n
                    ? "<div>".concat(a[2], ': <span className="value">') +
                      n +
                      "</span></div>"
                    : "") +
                  "<div>".concat(a[3], ': <span className="value">') +
                  l +
                  "</span></div>" +
                  "<div>".concat(a[4], ': <span className="value">') +
                  h +
                  "</span></div></div>";
          },
        },
      ...
      r(t, [
        ...
        },
        {
          ...
          value: function (t, e, i) {
            ...
            return (
              o || n || !l || "between" === h || (i = r.convertCatToNumeric(i)),
              i
            );
          },
        },
  ...
  N = (function () {
    function t(e) {
      a(this, t),
        (this.ctx = e),
        (this.w = e.w),
        (this.legendInactiveclassName = "legend-mouseover-inactive");
    }
    return (
      r(t, [
        {
        ...
        },
        {
          ...
          value: function (t) {
            ...
            if (
              ...
              (r.hasXaxisGroups =
                "category" === s.xaxis.type && s.xaxis.group.groups.length > 0),
  ...
  ht = (function () {
    function t(e) {
      ...
      (this.ev = this.w.config.chart.events),
        (this.selectedclassName = "apexcharts-selected"),
            ...
            if (d.length && l.globals.seriesGoals[e]) {
              var y = function () {
                ...
                d.forEach(function (i, a) {
                  (t +=
                    ' <div style="display: flex"><span className="apexcharts-tooltip-marker" style="background-color: '
                      .concat(
                        i.attrs.strokeColor,
              ...
              o.tooltipLabels.drawSeriesTexts({
                ...
                s.config.tooltip.followCursor
                  ? s.globals.isBarHorizontal
                    ? ((l = y - f.left + 15), (h = S()))
                    : ((l = A()),
                      (h = i.clientY - f.top - o.tooltipRect.ttHeight / 2 - 15))
                  : s.globals.isBarHorizontal
          ...
          value: function () {
            ...
            if (
              ...
              if (
                ...
                (r =
                  ((a / c) * parseInt(this.barCtx.barOptions.columnWidth, 10)) /
                  100),
                l.globals.isXNumeric)
              ) {
                  ...
                  (h =
                    c.globals.isXNumeric && c.globals.dataPoints > 1
                      ? ((i = c.globals.minXDiff / this.xRatio) *
                        ...
                        100
                      : (h *
                          parseInt(c.config.plotOptions.bar.columnWidth, 10)) /
                        100),
                  -1 ===
          ...
          value: function (t) {
            ...
            if (
              ...
              for (var L = 1; L < A; L++) {
                var P, I;
                if (
                  (null === (P = this.groupCtx.prevYVal[m - L]) || void 0 === P
                    ? void 0
                    : P[g]) < 0
                ) {
                  w =
              ...
              for (
                ...
                if (this.isHorizontal) {
                  ...
                  a.globals.isXNumeric &&
                    (g =
                      (a.globals.seriesX[n][A] - a.globals.minX) / this.xRatio -
                      v / 2),
                    (T = g + v * this.visibleI);
                  var F = (l - v * z) / 2;
                  if (a.config.series[n].data[A].x) {
            ...
            for (var M = n, X = 0; X < a; X++) {
              ...
              z
                ...
                : ((n =
                    ...
                    2 *
                      (this.isReversed ? i[r][X + 1] / A[this.yaxisIndex] : 0)),
                  "rangeArea" === e &&
                    (M =
                      p -
              ...
              (g = F.areaPaths),
                ...
                (C = F.linePath),
                this.appendPathFrom &&
                  ((P += k.line(o, this.zeroY)), (I += k.line(o, this.zeroY))),
      ...
      r(t, [
        {
          ...
          value: function () {
            ...
            (t.axisCharts =
              ...
              (t.chartclassName = ".apexcharts" + t.chartID),
