      ...
      columns: [
        {
          ...
          data: function (e) {
            return gridjs.html(
              '<div className="form-check checkbox-product-list">\t\t\t\t\t<input className="form-check-input" type="checkbox" value="' +
                e.id +
                '" id="checkbox-' +
                e.id +
        ...
        },
        {
          ...
          data: function (e) {
            return gridjs.html(
              '<div className="d-flex align-items-center"><div className="flex-shrink-0 me-3"><div className="avatar-sm bg-light rounded p-1"><img src="' +
                e.product.img +
                '" alt="" className="img-fluid d-block"></div></div><div className="flex-grow-1"><h5 className="fs-14 mb-1"><a href="apps-ecommerce-product-details.html" className="text-body">' +
                e.product.title +
                '</a></h5><p className="text-muted mb-0">Category : <span className="fw-medium">' +
                e.product.category +
                "</span></p></div></div>"
            );
          },
        ...
        { name: "Orders", width: "84px" },
        {
          ...
          formatter: function (e) {
            return gridjs.html(
              '<span className="badge bg-light text-body fs-12 fw-medium"><i className="mdi mdi-star text-warning me-1"></i>' +
                e +
                "</span></td>"
            );
          },
        ...
        },
        {
          ...
          formatter: function (e, t) {
            ...
            return gridjs.html(
              '<div className="dropdown"><button className="btn btn-soft-secondary btn-sm dropdown" type="button" data-bs-toggle="dropdown" aria-expanded="false"><i className="ri-more-fill"></i></button><ul className="dropdown-menu dropdown-menu-end"><li><a className="dropdown-item" href="apps-ecommerce-product-details.html"><i className="ri-eye-fill align-bottom me-2 text-muted"></i> View</a></li><li><a className="dropdown-item edit-list" data-edit-id=' +
                t +
                ' href="apps-ecommerce-add-product.html"><i className="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li><li className="dropdown-divider"></li><li><a className="dropdown-item remove-list" href="#" data-id=' +
                t +
                ' data-bs-toggle="modal" data-bs-target="#removeItemModal"><i className="ri-delete-bin-fill align-bottom me-2 text-muted"></i> Delete</a></li></ul></div>'
            );
          },
        },
      ],
  ...
  productListPublished = new gridjs.Grid({
    columns: [
      ...
      },
      {
        ...
        formatter: function (e, t) {
          return gridjs.html(
            '<div className="dropdown"><button className="btn btn-soft-secondary btn-sm dropdown" type="button" data-bs-toggle="dropdown" aria-expanded="false"><i className="ri-more-fill"></i></button><ul className="dropdown-menu dropdown-menu-end"><li><a className="dropdown-item" href="apps-ecommerce-product-details.html"><i className="ri-eye-fill align-bottom me-2 text-muted"></i> View</a></li><li><a className="dropdown-item" href="apps-ecommerce-add-product.html"><i className="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a></li><li className="dropdown-divider"></li><li><a className="dropdown-item remove-list" href="#" data-id=' +
              t._cells[0].data +
              ' data-bs-toggle="modal" data-bs-target="#removeItemModal"><i className="ri-delete-bin-fill align-bottom me-2 text-muted"></i> Delete</a></li></ul></div>'
          );
        },
