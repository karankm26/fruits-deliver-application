      ...
      var r = e.bookmark ? "active" : "",
        m = e.memberImg
          ...
          : '<div className="avatar-title border bg-light text-primary rounded-circle text-uppercase">' +
            ...
            "</div>";
      (document.querySelector("#team-member-list").innerHTML +=
        '<div className="col">            <div className="card team-box">                <div className="team-cover">                    <img src="' +
        e.coverImg +
        '" alt="" className="img-fluid" />                </div>                <div className="card-body p-4">                    <div className="row align-items-center team-row">                        <div className="col team-settings">                            <div className="row">                                <div className="col">                                    <div className="flex-shrink-0 me-2">                                        <button type="button" className="btn btn-light btn-icon rounded-circle btn-sm favourite-btn ' +
        r +
        '">                                            <i className="ri-star-fill fs-14"></i>                                        </button>                                    </div>                                </div>                                <div className="col text-end dropdown">                                    <a href="javascript:void(0);" data-bs-toggle="dropdown" aria-expanded="false">                                        <i className="ri-more-fill fs-17"></i>                                    </a>                                    <ul className="dropdown-menu dropdown-menu-end">                                        <li><a className="dropdown-item edit-list" href="#addmemberModal"  data-bs-toggle="modal" data-edit-id="' +
        e.id +
        '"><i className="ri-pencil-line me-2 align-bottom text-muted"></i>Edit</a></li>                                        <li><a className="dropdown-item remove-list" href="#removeMemberModal" data-bs-toggle="modal" data-remove-id="' +
        e.id +
        '"><i className="ri-delete-bin-5-line me-2 align-bottom text-muted"></i>Remove</a></li>                                    </ul>                                </div>                            </div>                        </div>                        <div className="col-lg-4 col">                            <div className="team-profile-img">                                <div className="avatar-lg img-thumbnail rounded-circle flex-shrink-0">' +
        m +
        '</div>                                <div className="team-content">                                    <a className="member-name" data-bs-toggle="offcanvas" href="#member-overview" aria-controls="member-overview">                                        <h5 className="fs-16 mb-1">' +
        e.memberName +
        '</h5>                                    </a>                                    <p className="text-muted member-designation mb-0">' +
        e.position +
        '</p>                                </div>                            </div>                        </div>                        <div className="col-lg-4 col">                            <div className="row text-muted text-center">                                <div className="col-6 border-end border-end-dashed">                                    <h5 className="mb-1 projects-num">' +
        e.projects +
        '</h5>                                    <p className="text-muted mb-0">Projects</p>                                </div>                                <div className="col-6">                                    <h5 className="mb-1 tasks-num">' +
        e.tasks +
        '</h5>                                    <p className="text-muted mb-0">Tasks</p>                                </div>                            </div>                        </div>                        <div className="col-lg-2 col">                            <div className="text-end">                                <a href="pages-profile.html" className="btn btn-light view-btn">View Profile</a>                            </div>                        </div>                    </div>                </div>            </div>        </div>'),
        bookmarkBtn(),
        editMemberList(),
        removeItem(),
        memberDetailShow();
