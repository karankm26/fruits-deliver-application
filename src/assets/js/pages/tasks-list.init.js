...
(xhttp.onload = function () {
  ...
  Array.from(e).forEach(function (e) {
    ...
    Array.from(t.slice(0, 3)).forEach(function (e) {
      ...
      tasksList.add({
        id:
          '<a href="apps-tasks-details.html" className="fw-medium link-primary">#VLZ' +
          e.id +
          "</a>",
        project_name:
          '<a href="apps-projects-overview.html" className="fw-medium link-primary">' +
          e.project_name +
          "</a>",
    ...
    tasksList.remove(
      "id",
      '<a href="apps-tasks-details.html" className="fw-medium link-primary">#VLZ501</a>'
    );
}),
...
function assignToUsers() {
  var s = [],
    ...
    e =
      ...
      s),
    t = '<div className="avatar-group flex-nowrap">';
  return (
    ...
    ? (Swal.fire({
        ...
        if (e.value) {
          for (i = 0; i < ids_array.length; i++)
            tasksList.remove(
              "id",
              `<a href="apps-tasks-details.html" className="fw-medium link-primary">${ids_array[i]}</a>`
            );
