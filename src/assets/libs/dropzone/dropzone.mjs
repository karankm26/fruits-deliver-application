...
let $4ca367182776f80b$var$defaultOptions = {
  ...
  addedfile(file) {
    ...
    if (this.previewsContainer && !this.options.disablePreviews) {
      file.previewElement =
        $3ed269f2f0fb224b$export$2e2bcd8739ae039.createElement(
      ...
      if (this.options.addRemoveLinks) {
        file._removeLink =
          $3ed269f2f0fb224b$export$2e2bcd8739ae039.createElement(
            `<a className="dz-remove" href="javascript:undefined;" data-dz-remove>${this.options.dictRemoveFile}</a>`
          );
...
var $4ca367182776f80b$export$2e2bcd8739ae039 =
...
class $3ed269f2f0fb224b$export$2e2bcd8739ae039 extends $4040acfd8584338d$export$2e2bcd8739ae039 {
  ...
  getQueuedFiles() {
    return this.getFilesWithStatus(
      $3ed269f2f0fb224b$export$2e2bcd8739ae039.QUEUED
    );
  }
  getUploadingFiles() {
    return this.getFilesWithStatus(
      $3ed269f2f0fb224b$export$2e2bcd8739ae039.UPLOADING
    );
  }
  getAddedFiles() {
    return this.getFilesWithStatus(
      $3ed269f2f0fb224b$export$2e2bcd8739ae039.ADDED
    );
  }
  ...
  init() {
    ...
    if (
      ...
      this.element.appendChild(
        $3ed269f2f0fb224b$export$2e2bcd8739ae039.createElement(
          `<div className="dz-default dz-message"><button className="dz-button" type="button">${this.options.dictDefaultMessage}</button></div>`
        )
      );
    if (this.clickableElements.length) {
      let setupHiddenFileInput = () => {
        ...
        $3ed269f2f0fb224b$export$2e2bcd8739ae039
        ...
        events: {
          click: (evt) => {
            ...
            if (
              ...
              $3ed269f2f0fb224b$export$2e2bcd8739ae039.elementInside(
                evt.target,
                this.element.querySelector(".dz-message")
              )
            )
  ...
  destroy() {
    ...
    return $3ed269f2f0fb224b$export$2e2bcd8739ae039.instances.splice(
      $3ed269f2f0fb224b$export$2e2bcd8739ae039.instances.indexOf(this),
      1
    );
  }
  ...
  getFallbackForm() {
    ...
    let fields =
      $3ed269f2f0fb224b$export$2e2bcd8739ae039.createElement(fieldsString);
    if (this.element.tagName !== "FORM") {
  ...
  paste(e) {
    if (
      $3ed269f2f0fb224b$var$__guard__(
  ...
  _addFilesFromDirectory(directory, path) {
    ...
    let errorHandler = (error) =>
      $3ed269f2f0fb224b$var$__guardMethod__(console, "log", (o) =>
        o.log(error)
      );
    var readEntries = () => {
  ...
  accept(file, done) {
    if (
      ...
      !$3ed269f2f0fb224b$export$2e2bcd8739ae039.isValidFile(
        file,
        this.options.acceptedFiles
      )
    )
      ...
      (dataUrl, canvas) => {
        if (canvas == null)
          ...
          if (resizeMimeType === "image/jpeg" || resizeMimeType === "image/jpg")
            ...
            resizedDataURL = $3ed269f2f0fb224b$var$ExifRestore.restore(
              file.dataURL,
              resizedDataURL
            );
          return callback(
            $3ed269f2f0fb224b$export$2e2bcd8739ae039.dataURItoBlob(
              resizedDataURL
            )
          );
        }
  ...
  createThumbnailFromUrl(
    ...
    img.onload = () => {
      ...
      return loadExif((orientation) => {
        ...
        $3ed269f2f0fb224b$var$drawImageIOSFix(
          ctx,
          img,
        ...
        file.upload.finishedChunkUpload = (chunk, response) => {
          ...
          for (let i = 0; i < file.upload.totalChunkCount; i++) {
            ...
            if (
              ...
              $3ed269f2f0fb224b$export$2e2bcd8739ae039.SUCCESS
            )
              allFinished = false;
          }
          if (allFinished)
  ...
  constructor(el, options) {
    ...
    let elementOptions =
      (left = $3ed269f2f0fb224b$export$2e2bcd8739ae039.optionsForElement(
        this.element
      )) != null
        ? left
        : {};
    this.options = $ewBKy$justextend(
      true,
      {},
      $4ca367182776f80b$export$2e2bcd8739ae039,
      elementOptions,
    ...
    if (
      ...
      !$3ed269f2f0fb224b$export$2e2bcd8739ae039.isBrowserSupported()
    )
    ...
    if (this.options.previewsContainer !== false) {
      if (this.options.previewsContainer)
        this.previewsContainer =
          $3ed269f2f0fb224b$export$2e2bcd8739ae039.getElement(
    ...
    if (this.options.clickable) {
      if (this.options.clickable === true)
        ...
        this.clickableElements =
          $3ed269f2f0fb224b$export$2e2bcd8739ae039.getElements(
...
$3ed269f2f0fb224b$export$2e2bcd8739ae039.optionsForElement = function (
  element
) {
  // Get the `Dropzone.options.elementId` for this element if it exists
  if (element.getAttribute("id"))
    return $3ed269f2f0fb224b$export$2e2bcd8739ae039.options[
      $3ed269f2f0fb224b$var$camelize(element.getAttribute("id"))
    ];
...
$3ed269f2f0fb224b$export$2e2bcd8739ae039.discover = function () {
  ...
  return (() => {
    ...
    for (let dropzone of dropzones) // Create a dropzone unless auto discover has been disabled for specific element
      if (
        $3ed269f2f0fb224b$export$2e2bcd8739ae039.optionsForElement(dropzone) !==
        false
      )
...
$3ed269f2f0fb224b$export$2e2bcd8739ae039.isBrowserSupported = function () {
  ...
  if (
    ...
    if (!("classList" in document.createElement("a"))) capableBrowser = false;
      ...
      if (
        $3ed269f2f0fb224b$export$2e2bcd8739ae039.blacklistedBrowsers !==
        undefined
      )
...
const $3ed269f2f0fb224b$var$without = (list, rejectedItem) =>
  list.filter((item) => item !== rejectedItem).map((item) => item);
// abc-def_ghi -> abcDefGhi
const $3ed269f2f0fb224b$var$camelize = (str) =>
...
$3ed269f2f0fb224b$export$2e2bcd8739ae039.elementInside = function (
  element,
  container
) {
...
$3ed269f2f0fb224b$export$2e2bcd8739ae039.confirm = function (
  question,
  accepted,
  rejected
) {
...
$3ed269f2f0fb224b$export$2e2bcd8739ae039.isValidFile = function (
  file,
  acceptedFiles
) {
...
// or uploading.
$3ed269f2f0fb224b$export$2e2bcd8739ae039.ACCEPTED =
  $3ed269f2f0fb224b$export$2e2bcd8739ae039.QUEUED;
$3ed269f2f0fb224b$export$2e2bcd8739ae039.UPLOADING = "uploading";
$3ed269f2f0fb224b$export$2e2bcd8739ae039.PROCESSING =
  $3ed269f2f0fb224b$export$2e2bcd8739ae039.UPLOADING; // alias
...
var $3ed269f2f0fb224b$var$drawImageIOSFix = function (
  ctx,
  img,
  sx,
  sy,
