    ...
    columns: [
      ...
      },
      {
        ...
        formatter: function (e) {
          return gridjs.html(
            '<div className="d-flex align-items-center"><div className="flex-shrink-0 me-3"><div className="avatar-sm bg-light rounded p-1"><img src="assets/images/products/' +
              e[0] +
      ...
      },
      {
        ...
        formatter: function (e) {
          return gridjs.html(
            e[0] + '<small className="text-muted ms-1">' + e[1] + "</small>"
          );
        },
      },
      {
